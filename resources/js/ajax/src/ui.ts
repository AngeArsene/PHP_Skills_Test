...
export const formatTableRow = (product: Product): string => `
    <tr>
        <th>${product.id}</th>
        <td>${product.name}</td>
...
export const editModalForm = (product: Product): string => `
...
export const deleteModalForm = (id: number): string => `
...
export const removeModalForm = (id: string | null = null): void => {
